The `./figure*` directories contain the data and code to reproduce the figures in the manuscript. Note that these are "raw" figures (i.e., without formatting for consistent style, etc.). 
